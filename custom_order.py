class CustomOrder:
    ...
    def __repr__(self):
        return f"CustomOrder('{self.customer_name}', '{self.item_type}', {self.quantity}, {self.price})"
...
order1 = CustomOrder("Dre", "Watches", 10, 6000)
print(order1)
print(order1.apply_discount(10))
print(order1.is_bulk())

order2 = CustomOrder("Blaike", "Shoes", 4, 2500)
print(order2)
