...
if has_venv and python_version:
    print("Dev environment is ready to go!")
else:
    print("Something is not quite right with your Dev environment setup.")
...
match day:
    ...
    case "Sunday":
        print("Today is Sunday and it is the beginning of the week, so we will review all the topics covered this week.")
    case _:
